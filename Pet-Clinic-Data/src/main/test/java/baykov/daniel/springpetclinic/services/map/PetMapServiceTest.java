...
public class PetMapServiceTest {
    ...
    void setUp() {
        ...
        petMapService.save(Pet.builder().id(petId).visits(new HashSet<>()).build());
    }
    ...
    void saveExistingId() {
        ...
        Pet pet2 = Pet.builder().id(id).visits(new HashSet<>()).build();
    ...
    void saveNoId() {
        ...
        Pet savedPet = petMapService.save(Pet.builder().visits(new HashSet<>()).build());
    ...
    void deleteWithWrongId() {
        ...
        Pet pet = Pet.builder().id(5L).visits(new HashSet<>()).build();
    ...
    void deleteWithNullId() {
        ...
        Pet pet = Pet.builder().visits(new HashSet<>()).build();
